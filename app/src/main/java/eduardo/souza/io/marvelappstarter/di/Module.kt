package eduardo.souza.io.marvelappstarter.di
...
import eduardo.souza.io.marvelappstarter.data.local.MarvelDatabase
import eduardo.souza.io.marvelappstarter.data.remote.ServiceApi
import eduardo.souza.io.marvelappstarter.util.Constants
import eduardo.souza.io.marvelappstarter.util.Constants.BASE_URL
import eduardo.souza.io.marvelappstarter.util.Constants.DATABASE_NAME
...
object Module {
    ...
    @Singleton
    @Provides
    fun provideMarvelDatabase(@ApplicationContext context: Context) = Room.databaseBuilder(context, MarvelDatabase::class.java, DATABASE_NAME)
        .build()
