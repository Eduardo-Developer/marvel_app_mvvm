...
import eduardo.souza.io.marvelappstarter.data.model.comic.ComicModel
import eduardo.souza.io.marvelappstarter.databinding.ItemComicBinding
    ...
    private val differCallback = object : DiffUtil.ItemCallback<ComicModel>() {
        ...
        override fun areContentsTheSame(oldItem: ComicModel, newItem: ComicModel): Boolean {
            return oldItem.id == newItem.id && oldItem.description == newItem.description &&
                    oldItem.title == newItem.title && oldItem.thumbnail.path == newItem.thumbnail.path &&
