package eduardo.souza.io.marvelappstarter.ui.search
...
import eduardo.souza.io.marvelappstarter.databinding.FragmentSearchCharacterBinding
...
import eduardo.souza.io.marvelappstarter.util.Constants.DEFAULT_QUERY
import eduardo.souza.io.marvelappstarter.util.Constants.LAST_SEARCH_QUERY
...
class SearchCharacterFragment : BaseFragment<FragmentSearchCharacterBinding, SearchCharacterViewModel>() {
    override val viewModel: SearchCharacterViewModel
        by viewModels()
