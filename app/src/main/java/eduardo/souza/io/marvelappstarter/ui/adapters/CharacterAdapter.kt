package eduardo.souza.io.marvelappstarter.ui.adapters
...
import eduardo.souza.io.marvelappstarter.databinding.ItemCharacterBinding
import eduardo.souza.io.marvelappstarter.util.limitDescription
import eduardo.souza.io.marvelappstarter.util.loadImage
...
class CharacterAdapter : RecyclerView.Adapter<CharacterAdapter.CharacterViewHolder>() {
    ...
    private val differCallback = object : DiffUtil.ItemCallback<CharacterModel>() {
        ...
        override fun areContentsTheSame(oldItem: CharacterModel, newItem: CharacterModel): Boolean {
            return oldItem.id == newItem.id && oldItem.description == newItem.description &&
                    oldItem.name == newItem.name && oldItem.thumbnailModel.path == newItem.thumbnailModel.path &&
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CharacterViewHolder {
        return CharacterViewHolder(ItemCharacterBinding.inflate(
